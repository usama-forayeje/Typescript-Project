"use strict";
const gerUsername = document.querySelector("#user");
...
async function fetchUserData(url) {
    try {
        ...
        const userInfo = await myCustomFetch(url, {});
        allUsers = userInfo;
...
formSubmit.addEventListener("submit", async (e) => {
    ...
    const matchingUser = allUsers.filter((user) => user.login.toLowerCase().includes(searchParson));
